  ...
  return (
    <AnimatePresence>
      {!isFlipping && (
        ...
        >
          <div
            className={`relative w-40 h-40 md:w-56 md:h-56 rounded-full flex items-center justify-center border-[6px] shadow-2xl transition-all duration-500 ${
              result === 'win' 
          ...
          >
            {/* Inner ring */}
            <div
              className={`absolute inset-3 rounded-full border-2 border-dashed transition-colors duration-500 ${
                result === 'win' 
            ...
            {/* Currency Symbol */}
            <span
              className={`text-6xl md:text-8xl font-black drop-shadow-lg transition-colors duration-500 ${
                result === 'win' 
                  ? 'text-emerald-100' 
                  : result === 'loss' 
                    ? 'text-rose-100' 
